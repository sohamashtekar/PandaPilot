...
from openpilot.selfdrive.car.mazda.values import mazda_ti_mode
...
class Controls:
  ...
  def state_control(self, CS):
    ...
    if lac_log.active and not recent_steer_pressed and not self.CP.notCar and not mazda_ti_mode(self.CP):
